                ...
                if ( !empty($gallery_lists) ) {
                    ...
                    foreach ( $gallery_lists as $gallery_row ) {
                        ...
                        <tr class="<?php echo ($sn % 2 == 0) ? 'alternate' : ''; ?>">
                            ...
                            <td style="width:400px"><input type="text" readonly="readonly" value='[everest_gallery alias="<?php echo esc_attr($gallery_row[ 'gallery_alias' ]); ?>"]'  onFocus="this.select();"/></td>
                            ...
                            <td>
                                ...
                                <a class="eg-copy" href="javascript:void(0);" data-gallery-id="<?php echo esc_attr($gallery_row[ 'gallery_id' ]); ?>" title="<?php _e('Copy Gallery', 'everest-gallery-lite'); ?>"><?php _e('Copy', 'everest-gallery-lite'); ?></a>
                                ...
                                <a class="eg-delete" href="javascript:void(0)" data-gallery-id="<?php echo esc_attr($gallery_row[ 'gallery_id' ]); ?>" title="<?php _e('Delete Gallery', 'everest-gallery-lite'); ?>"><?php _e('Delete', 'everest-gallery-lite'); ?></a>
                            </td>
                        </tr>
                        <?php
                        $sn++;
