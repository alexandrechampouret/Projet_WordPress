<div class="eg-each-item <?php echo esc_attr($animation_class); ?> <?php echo isset($gallery_item_details[ 'filters' ]) ? implode(' ', array_map('esc_attr', $gallery_item_details[ 'filters' ])) : ''; ?>" data-eg-item-key="<?php echo esc_attr($gallery_item_key); ?>">
    <?php
    ...
    <div class="eg-masonary-padding">
        <div class="eg-overlay-wrapper">
            ...
            <a href="<?php echo esc_attr($attachment_full_src[ 0 ]); ?>"
               data-lightbox-type="<?php echo esc_attr($gallery_details[ 'lightbox' ][ 'lightbox_type' ]); ?>"
               rel="prettyPhoto[gallery_<?php echo esc_attr($gallery_row[ 'gallery_id' ]); ?>]"
               title="<?php echo esc_attr($gallery_item_details[ 'item_caption' ]); ?>"
               data-item-type="<?php echo esc_attr($gallery_item_type); ?>"
               data-index="<?php echo esc_attr($item_counter); ?>"
               data-total-items="<?php echo esc_attr($total_items); ?>"
               >
                <img src="<?php echo esc_attr($attachment_src[ 0 ]); ?>" alt="<?php echo esc_attr($gallery_item_details[ 'item_title' ]); ?>"/>
            </a>
            <div class="eg-mask">
