...
?>
<div class="eg-masonary-wrap eg-wrap <?php echo esc_attr($column_class); ?> <?php echo esc_attr($layout_class); ?> <?php echo esc_attr($components_class); ?>"
     data-desktop-column="<?php echo esc_attr($desktop_columns); ?>"
     data-tablet-column="<?php echo esc_attr($tablet_columns); ?>"
     data-mobile-column="<?php echo esc_attr($mobile_columns); ?>"
     ...
     if ( $gallery_details[ 'lightbox' ][ 'lightbox_type' ] == 'everest_lightbox' ) {
         ...
         ?>
         data-lightbox-theme ="<?php echo esc_attr($lightbox_theme); ?>"
     <?php }
     ?>
    ...
    <div class="eg-masonary-items-wrap" data-masonary-id="<?php echo esc_attr($gallery_id); ?>">
        <?php
